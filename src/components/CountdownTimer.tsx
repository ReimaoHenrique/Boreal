...
export default function CountdownTimer({ 
  ...
  if (isExpired) {
    return (
      ...
      >
        <GlassCard className="p-6 text-center neon-purple" glow>
          <h3 className="text-2xl font-bold text-glow-cyan mb-4">
            🎉 O EVENTO COMEÇOU!
          </h3>
          <p className="text-gray-300">
            O {eventName} já está acontecendo! Ainda há ingressos disponíveis na porta.
          </p>
        </GlassCard>
      </motion.div>
    );
  ...
  return (
    <motion.div
      ...
      className="w-full max-w-2xl mx-auto"
    >
      <GlassCard className="p-6 neon-purple" glow>
        {/* Header com promoção */}
        ...
        <div className="grid grid-cols-4 gap-4 mb-6">
          {[
            ...
            >
              <div className="bg-gradient-to-br from-cyan-900/50 to-purple-900/50 rounded-lg p-3 border border-white/10">
                <motion.div
                  key={item.value}
